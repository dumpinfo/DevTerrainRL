...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.RecurrentParameter recurrent_param = 145;
  bool has_recurrent_param() const;
  void clear_recurrent_param();
  static const int kRecurrentParamFieldNumber = 145;
...
inline void MemoryDataParameter::set_has_label_size() {
  _has_bits_[0] |= 0x00000010u;
}
inline void MemoryDataParameter::clear_has_label_size() {
  _has_bits_[0] &= ~0x00000010u;
}
...
inline ::google::protobuf::uint32 MemoryDataParameter::label_size() const {
  // @@protoc_insertion_point(field_get:caffe.MemoryDataParameter.label_size)
  return label_size_;
}
inline void MemoryDataParameter::set_label_size(::google::protobuf::uint32 value) {
  set_has_label_size();
  label_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.MemoryDataParameter.label_size)
}
